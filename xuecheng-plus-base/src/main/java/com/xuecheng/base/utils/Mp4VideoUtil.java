...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        //ffmpeg的路径
        String ffmpeg_path = "F:\\ProgrammingTools\\ffmpeg\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "F:\\images\\集合进阶-03-Map集合的第一种遍历方式（键找值）.mp4";
        //转换后mp4文件的名称
        String mp4_name = "集合进阶-03-Map集合的第一种遍历方式（键找值）.avi";
        //转换后mp4文件的路径
        String mp4_path = "F:\\images\\集合进阶-03-Map集合的第一种遍历方式（键找值）.avi";
        //创建工具类对象
        ...
        /*ProcessBuilder builder = new ProcessBuilder();
        builder.command("D:\\Bin\\QQScLauncher.exe");
        //将标准输入流和错误输入流合并，通过标准输入流程读取信息
        builder.redirectErrorStream(true);
        Process p = builder.start();*/
    }
