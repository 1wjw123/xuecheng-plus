...
public class MediaFileServiceImpl implements MediaFileService {
    ...
    public UploadFileResultDto uploadFile(Long companyId, UploadFileParamsDto uploadFileParamsDto, String localFilePath, String objectName) {
        ...
        //将文件信息存储到数据库
        MediaFiles mediaFiles = currenProxy.addMediaFilesToDb(companyId, fileMd5, uploadFileParamsDto, bucket_Files, objectName);
    ...
    public RestResponse mergechunks(Long companyId, String fileMd5, int chunkTotal, UploadFileParamsDto uploadFileParamsDto) {
        ...
        //文件入库
        currenProxy.addMediaFilesToDb(companyId,fileMd5,uploadFileParamsDto,bucket_Video,mergeFilePath);
        //=====清除分块文件=====
